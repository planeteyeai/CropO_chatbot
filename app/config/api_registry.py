...
API_REGISTRY: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "base_url_setting": "CROPO_API_BASE_URL",
        "endpoint": "/irrigation-and-soil-moisture",
        "auth_header": "Authorization",
        "auth_setting": "CROPO_API_KEY",
    ...
    },
    {
        ...
        "description": "Comprehensive daily agronomic synthesis covering canopy NDVI health, soil water balance, weather, and actionable farm recommendations.",
    },
]
